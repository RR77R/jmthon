...
class Config(object):
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "jmthon")
    MY_GROUP = os.environ.get("YOUR_GROUP", "jmthon_support")
    ...
    JMTHON_SESSION = os.environ.get("JMTHON_SESSION", None)
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./jmthon/resources/pics/jmthon_grp_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/RR77R/jmthon")
