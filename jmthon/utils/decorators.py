...
from jmthon.clients import H2, H3, H4, H5
...
def admin_cmd(pattern=None, command=None, **args):
    ...
    # blacklisted chats. 
    # jmthon will not respond in these chats.
