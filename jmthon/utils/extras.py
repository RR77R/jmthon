...
from jmthon import *
from jmthon.helpers.pasters import pasty
...
async def edit_or_reply(
    ...
    if aslink or deflink:
        linktext = linktext or "الرسالة كبيرة جدا لذلك تم لصقها في الموقع"
...
# delete timeout
async def delete_jmthon(event, text, time=None, parse_mode=None, link_preview=None):
    parse_mode = parse_mode or "md"
    link_preview = link_preview or False
    time = time or 10
    if event.sender_id in Config.SUDO_USERS:
